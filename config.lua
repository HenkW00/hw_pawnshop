...
--[[{ --EXAMPLE
    ...
    { 
        ...
        items = {
            { item = 'water', label = 'Water', price = 12, currency = 'money' }, -- Self explanatory I would hope
            { item = 'lockpick', label = 'Lockpick', price = 12, currency = 'black_money' }, -- Self explanatory I would hope
            { item = 'burger', label = 'Burger', price = 12, currency = 'money' }, -- Self explanatory I would hope
            { item = 'water', label = 'Water', price = 12, currency = 'money' }, -- Self explanatory I would hope
            { item = 'steel', label = 'Steel', price = 12, currency = 'money' }, -- Self explanatory I would hope
            { item = 'plastic', label = 'Plastic', price = 12, currency = 'money' }, -- Self explanatory I would hope
            { item = 'iron', label = 'Iron', price = 12, currency = 'money' }, -- Self explanatory I would hope
            { item = 'copper', label = 'Copper', price = 12, currency = 'money' }, -- Self explanatory I would hope
            { item = 'diamond', label = 'Diamond', price = 12, currency = 'black_money' }, -- Self explanatory I would hope
        }
    },
}